...
bool Screen::init() {
	...
	if (m_renderer == NULL) {
		cout << "SDL couldn't create renderer" << endl;
	...
	if (m_texture == NULL) {
		cout << "SDL couldn't create texture" << endl;
	...
	// TODO: Check if memory could be succesfully allocated
...
void Screen::setPixel(int i, int j, Uint8 red, Uint8 green, Uint8 blue) {
	...
	m_buffer1[(j * SCREEN_WIDTH) + i] = color;
